...
class FishCortsScreen extends StatefulWidget {
  ...
  @override
  State<FishCortsScreen> createState() => _FishCortsScreenState();
}

class _FishCortsScreenState extends State<FishCortsScreen> {
  ...
  final List<CorteModel> _todos = const [
    CorteModel(
      ...
      preco: 24.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/file_tilapia.png',
    ),
    CorteModel(
      nome: 'Filé de salmão',
      preco: 79.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/file_salmao.png',
    ),
    CorteModel(
      nome: 'Filé de merluza',
      preco: 32.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/file_merluza.png',
    ),
    CorteModel(
      nome: 'Atum fresco',
      preco: 64.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/atum_fresco.png',
    ),
    CorteModel(
      nome: 'Bacalhau dessalgado',
      preco: 89.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/bacalhau.png',
    ),
    CorteModel(
      nome: 'Dourado inteiro',
      preco: 28.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/dourado.png',
    ),
    CorteModel(
      nome: 'Camarão VG',
      preco: 69.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/camarao.png',
    ),
    CorteModel(
      nome: 'Filé de robalo',
      preco: 58.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/file_robalo.png',
    ),
    CorteModel(
      nome: 'Sardinha fresca',
      preco: 14.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/sardinha.png',
    ),
    CorteModel(
      nome: 'Lula limpa',
      preco: 44.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/lula.png',
    ),
    CorteModel(
      nome: 'Polvo',
      preco: 52.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/polvo.png',
    ),
    CorteModel(
      nome: 'Filé de corvina',
      preco: 36.90,
      unidade: '/kg',
      imagemAsset: 'assets/images/file_corvina.png',
    ),
  ];
